...
class SupplyFood
{
    ...
    /**
     * @var File|null
     * @Vich\UploadableField(mapping="food_image", fileNameProperty="filename")
     */
    private $imageFile;
     ...
     * @return SupplyFood
     */
    public function setFilename(?string $filename): SupplyFood
    {
     ...
     * @throws \Exception
     */
    public function setImageFile(?File $imageFile): SupplyFood
    {
